...
public class G21 extends AbstractFunction {
	...
	private static double[] domainsMin = new double[]{0, 0, Double.MIN_VALUE, 100, 6.3, 5.9, 4.5};	
	private static double[] domainsMax = new double[]{1000, Double.MAX_VALUE, 40, 300, 6.7, 6.4, 6.25};
