...
public class Start_Metrics {
	public static void main(String[] args) {
		//Algorithms
		AbstractAlgorithm[] algorithms = new AbstractAlgorithm[5];
		algorithms[0] = new MET_FsR();
		algorithms[1] = new MET_FVC();
		algorithms[2] = new MET_PiIZ_001();
		algorithms[3] = new MET_PiIZ_025();
		algorithms[4] = new MET_RFBx();
