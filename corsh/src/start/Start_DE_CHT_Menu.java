...
public class Start_DE_CHT_Menu {
	...
	private static AbstractAlgorithm[] getAlgorithmsList(String type, String set) {
		...
		if(type.equals("Metrics")) {
			...
			algorithms[0] = new MET_FVC();
			algorithms[1] = new MET_FsR();
			algorithms[2] = new MET_RFBx();
			algorithms[3] = new MET_PiIZ_001();
			algorithms[4] = new MET_PiIZ_025();
		}
